...
(function initLangSwitcher() {
  ...
  const T = {
    ...
    'Izin Kerja Dingin (Cold Work)': 'Cold Work Permit',
    'Pekerjaan proyek yang berkaitan dengan aktivitas berisiko, kecuali pekerjaan yang melibatkan api. Penggalian, Pemasangan kabel, Pemasangan perancah, Pengecoran beton, Pengangkatan, Bongkar muat, Radiografi, Pengujian kelistrikan, Pengecatan, Peledakan, dll.': 'Project work related with risky except hot work activity. Excavation, Cable pulling, Scaffolding, Concrete casting, Lifting, Loading/Unloading, Radiography, Electrical Testing, Painting, Blasting, Etc.',
    '🔌 Pemasangan Kabel': '🔌 Cable Pulling',
    '🏗️ Perancah': '🏗️ Scaffolding',
    '🧱 Pengecoran': '🧱 Concrete Casting',
    '📦 Bongkar Muat': '📦 Loading/Unloading',
    '☢️ Radiografi': '☢️ Radiography',
    '🎨 Pengecatan': '🎨 Painting',
    ...
    'Inisiatif & Kampanye Berkelanjutan': 'Sustainable Initiatives & Campaigns',
    'Mengembangkan budaya keselamatan dan kesehatan yang proaktif melalui program inovatif dan partisipasi seluruh karyawan di setiap lini.': 'Developing a proactive safety and health culture through innovative programs and participation of all employees across all lines.',
    'Jelajahi Program': 'Explore Programs',
    'Jadwal Kampanye': 'Campaign Schedule',
    'Program Aktif': 'Active Programs',
    'Partisipasi Karyawan': 'Employee Participation',
    'Kampanye Besar Tahunan': 'Major Annual Campaigns',
    'Sesi Pelatihan Selesai': 'Completed Training Sessions',
    'Program Terkini': 'Latest Programs',
    'Inisiatif Terpadu Departemen HSE': 'HSE Department Integrated Initiatives',
    'Berikut adalah program dan kampanye yang sedang berjalan untuk meningkatkan mutu keselamatan, kesehatan kerja, dan perlindungan lingkungan.': 'Here are the ongoing programs and campaigns to improve the quality of occupational safety, health, and environmental protection.',
    'Penghargaan HSE': 'HSE Awards',
    'Program apresiasi bulanan bagi pekerja dan departemen dengan kinerja keselamatan terbaik.': 'Monthly appreciation program for workers and departments with the best safety performance.',
    'Sadar Keselamatan': 'Safety Awareness',
    'Kampanye proaktif peningkatan kesadaran perilaku aman saat bekerja di area risiko tinggi.': 'Proactive campaign to increase awareness of safe behavior when working in high-risk areas.',
    'Kebugaran Jasmani': 'Physical Fitness',
    'Inisiatif kesehatan setiap Jumat untuk menjaga fisik agar tetap bugar sebelum memulai aktivitas.': 'Health initiative every Friday to keep physical shape fit before starting activities.',
    'Zero Waste Hero': 'Zero Waste Hero',
    'Mendorong pembatasan limbah rumah tangga dan industri di lingkungan pabrik dan mes.': 'Encouraging the restriction of household and industrial waste within the plant and camp environment.',
    'Punya Ide Program Keselamatan?': 'Have a Safety Program Idea?',
    'Kami selalu terbuka dengan saran konstruktif dari setiap individu. Suarakan ide inisiatif Anda yang dapat meningkatkan mutu HSE bersama di lingkungan kita.': 'We are always open to constructive suggestions from every individual. Voice your initiative ideas that can improve our collective HSE quality in our environment.',
    'Kirim Usulan Program': 'Submit Program Proposal',
    'Lihat Detail →': 'View Details →',
    'Mandatory': 'Mandatory',
    'Google Form': 'Google Form',
    'Link Induction': 'Link Induction',
    'Link Inspection Apart': 'Link Inspection Apart',
    'Link Inspection Rigger (Lifting Equipment)': 'Link Inspection Rigger (Lifting Equipment)',
  };
